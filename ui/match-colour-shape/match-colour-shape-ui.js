...
function newRound() {
  ...
  var colWrong = pool.filter(function(o) { return o.col !== col; }).filter(function(o) { return o.type === type; });
  var typeWrong = pool.filter(function(o) { return o.col === col; }).filter(function(o) { return o.type !== type; });
  var guaranteed = [colWrong[0], typeWrong[0]].filter(Boolean);
  var rest = pool.filter(function(o) { return guaranteed.indexOf(o) === -1; });
  var distractors = guaranteed.concat(rest).slice(0, 5);
