...
export function slotHtml(id, lbl) {
  return '<div style="display:flex;flex-direction:column;align-items:center;gap:4px;"><div id="' + id + '" style="width:76px;height:76px;border-radius:50%;border:4px solid #ddd;background:#f0f0f0;cursor:pointer;"></div><div id="' + id + '-label" style="font-size:0.85em;color:#bbb;font-weight:bold;">' + lbl + '</div></div>';
}
