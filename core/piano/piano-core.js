var PIANO_CONFIG = {
  NOTES: ['C4','D4','E4','F4','Gb4','G4','A4','B4','C5','D5','E5','F5','G5'],
  NOTE_LABELS: ['C','D','E','F','F#','G','A','B','\u2191C','\u2191D','\u2191E','\u2191F','\u2191G'],
  KEY_COLORS: ['#FFB3B3','#FFCBA4','#FFF0A3','#B3FFB3','#D4D4FF','#A3D9FF','#B3C6FF','#E0B3FF','#FFB3E6','#B3FFEE','#D4FFB3','#FFCCF2','#C5F2CC'],
  HIT_WINDOW_MS: 400,
  LOOKAHEAD_MS: 4000,
